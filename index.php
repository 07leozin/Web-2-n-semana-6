...
<body>
  ...
  <main class="container">
    <h2 class="subtitle">Nosso Cardápio de Bebidas</h2>
    ...
    <section class="menu-grid">
      <article class="bebida-card">
        ...
        <div class="info">
          <h3>Suco Natural</h3>
          <p>Suco de frutas frescas, sem adição de açúcar.</p>
          <div class="details">
            <span class="preco">R$ 8,00</span>
            <a href="suco.php" class="btn">Comprar</a>
          </div>
        </div>
      </article>
      ...
      <article class="bebida-card">
        ...
        <div class="info">
          <h3>Refrigerante</h3>
          <p>Lata de refrigerante tradicional ou zero.</p>
          <div class="details">
            <span class="preco">R$ 6,00</span>
            <a href="refrigerante.php" class="btn">Comprar</a>
          </div>
        </div>
      </article>
      ...
      <article class="bebida-card">
        ...
        <div class="info">
          <h3>Café Espresso</h3>
          <p>Café espresso forte e encorpado.</p>
          <div class="details">
            <span class="preco">R$ 5,00</span>
            <a href="cafe.php" class="btn">Comprar</a>
          </div>
        </div>
      </article>
      ...
      <article class="bebida-card">
        ...
        <div class="info">
          <h3>Chá Gelado</h3>
          <p>Chá natural servido gelado, com toque de limão.</p>
          <div class="details">
            <span class="preco">R$ 7,00</span>
            <a href="cha.php" class="btn">Comprar</a>
          </div>
        </div>
      </article>
    </section>
